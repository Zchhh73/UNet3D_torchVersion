...
class LITS_fix:
    ...
    def fix_data(self):
        ...
        for ct_file in os.listdir(self.raw_root_path + 'data/'):
            ...
            seg = sitk.ReadImage(os.path.join(self.raw_root_path + 'label/', ct_file.replace('image', 'mask')),
                                 sitk.sitkInt8)
            ...
            sitk.WriteImage(new_seg,
                            os.path.join(self.fixed_path + 'label/', ct_file.replace('image', 'mask')))
...
def main():
    raw_dataset_path = r'F:\Verse_Data\Data\Verse_train\\'
    fixed_dataset_path = r'F:\Verse_Data\fixed_path\\'
