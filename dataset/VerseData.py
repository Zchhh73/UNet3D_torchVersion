...
def main():
    fixd_path = r'F:\Verse_Data\fixed_path'
    dataset = Verse_DataSet([16, 128, 128], 0.5, fixd_path, mode='train')  # batch size
    data_loader = DataLoader(dataset=dataset, batch_size=2, num_workers=0, shuffle=True)
