...
import sys
sys.path.append('..')
from models.HDenseUnet.denseunet import DenseUnet
from models.HDenseUnet.denseunet3d import DenseUnet3D
...
class HDenseUnet(nn.Module):
    def __init__(self, num_classes=3):
        ...
        self.denseunet = DenseUnet(in_ch=1, num_classes=26)
        self.denseunet3d = DenseUnet3D(in_ch=1, num_classes=26)
...
if __name__ == '__main__':
    ...
    model = HDenseUnet(num_classes=26).cuda()
    for i in range(100):
        y = model(x)
        print(y.shape)
